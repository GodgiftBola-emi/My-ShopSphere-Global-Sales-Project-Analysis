...
Ensuring consistency in formatting and values
Verifying that all records were complete and analysis-ready
Organizing the data for easy aggregation using Excel tools
Identified key variables (independent vs dependent)

Clean and well-structured data made it easier to:
Build accurate pivot tables
Create reliable visualizations
...
What kind of insights can this dataset generate?

I also defined the business focus of the analysis:
Revenue performance across regions and cities
Product contribution to overall sales
Customer and sales representative impact
...
Sophia Brown and Daniel Smith were the top-performing sales representatives.
A few top customers contributed significantly to total revenue.
Texas stood out as the highest-performing state.
Cameras and monitors dominated product sales.
...
Certain cities and states act as revenue anchors, driving overall performance.
Product performance is uneven, with a few categories dominating sales.
...
Revenue by Sales Representative (identifying top contributors)
Regional Distribution Chart (showing balanced performance)
Top Customers Analysis (revealing revenue concentration)
Product Performance Chart (comparing categories)
Yearly Revenue Trend (tracking growth and decline patterns)
...
Investigate and Address the Revenue Dip:
Investigate the decline in 2024 and implement strategies such as promotions or pricing adjustments.
Reduce and Diversify Revenue Sources:
Reduce dependency on top customers and sales reps by expanding outreach and strengthening the sales team.
ScaleOptimize Product Strategy:
Scale high-performing products while improving or repositioning underperforming ones.
Introduce and Encourage Bulk Purchases:
Introduce discounts and bundles to drive higher transaction volumes.
Apply Improvement to Underperforming Regions:
Apply successful strategies from top regions to areas with lower performance.
